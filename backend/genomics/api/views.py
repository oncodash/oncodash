                        ...
                        alteration_rows = [
                            {
                                ...
                                'AD.0': f'{grouped_alterations_qs[0].ad0}',
                                'AD.1': f'{grouped_alterations_qs[0].ad1}',
                                'DP': f'{grouped_alterations_qs[0].dp}',
                                'AF': f'{grouped_alterations_qs[0].af}',
                                'nMajor': f'{grouped_alterations_qs[0].nMajor}',
