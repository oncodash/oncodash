# Generated by Django 3.2.10 on 2022-02-03 15:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cud_stage', models.CharField(choices=[('IA', 'Ia'), ('IB', 'Ib'), ('IC1', 'Ic1'), ('IC2', 'Ic2'), ('IC3', 'Ic3'), ('IIA', 'Iia'), ('IIB', 'Iib'), ('IIIA1i', 'Iiia1I'), ('IIIA1ii', 'Iiia1Ii'), ('IIIA2', 'Iiia2'), ('IIIB', 'Iiib'), ('IIIC', 'Iiic'), ('IVA', 'Iva'), ('IVB', 'Ivb')], max_length=7)),
                ...
                ('cud_survival', models.CharField(choices=[('DEATHUNKNOWN', 'Death due to unknown reason'), ('DEATHCANCER', 'Death due to cancer'), ('ALIVE', 'Alive')], max_length=15)),
                ('cud_treatment_strategy', models.CharField(choices=[('NACT', 'Neo-adjuvant chemotherapy'), ('PDS', 'Primary debulking surgery')], max_length=4)),
                ('cud_current_treatment_phase', models.CharField(choices=[('PROGRESSION', 'Progression'), ('FOLLOWUP', 'Follow.-up'), ('PRIMARYCHEMO', 'Primary chemotherapy'), ('DRUGTRIAL', 'Drug trial'), ('HORMONAL', 'Hormonal treatment')], max_length=15)),
