...
class ClinicalViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, pk=None):
        ...
        if len(timelinerecords) != 0:
            ...
            chemotherapy = TimelineRecord.objects.filter(patient=patient, event__in=['chemotherapy_dose']).order_by("date_relative").values_list("date_relative", "event").distinct() # This line assumes that we will have at most 10 progressions
