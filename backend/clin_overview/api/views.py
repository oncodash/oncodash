...
class ClinicalViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, pk=None):
        ...
        if len(timelinerecords) != 0:
            ...
            chemotherapy = TimelineRecord.objects.filter(patient=patient, event="chemotherapy_dose").order_by("date_relative").values_list("date_relative", "name").distinct() # This line assumes that we will have at most 10 progressions
